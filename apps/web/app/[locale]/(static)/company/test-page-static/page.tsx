...
export const metadata: Metadata = {
  title: "Company - Test Page Static",
  description: "atsignal Test Page Static",
};
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#ffffff', paddingBottom: '1rem' }}>
        ...
        <div className="hero-page">
            ...
            <div style={{ width: '100%', textAlign: 'center' }}>
                <h1 style={{ marginBottom: '0.5rem' }}>atsignal Test pageg Static</h1>
                <p>atsignal Test Page Static입니다.</p>
            </div>
            </div>
        </div>

...
exports.subscribeNewsletterApi = exports.subscribeNewsletter = void 0;
...
const subscribeNewsletter = async (req, res) => {
    ...
    try {
        ...
        try {
            ...
            const result = await (0, client_1.syncSubscriber)({
                email: payload.email,
                name: payload.name,
            ...
            const responseValue = result.data?.Value;
            // 이미 구독 중인 이메일인지 확인
 ...
 */
exports.subscribeNewsletterApi = functions.region("asia-northeast3").https.onRequest(async (req, res) => {
    ...
    // 실제 요청 처리
    await (0, exports.subscribeNewsletter)(req, res);
});

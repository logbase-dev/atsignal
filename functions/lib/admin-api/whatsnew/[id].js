...
async function handle(request, response, id) {
    try {
        if (request.method === "GET") {
            const whatsnew = await (0, whatsnewService_1.getWhatsNewById)(id);
            if (!whatsnew) {
        ...
        if (request.method === "PATCH") {
            ...
            if (action === "incrementViews") {
                await (0, whatsnewService_1.incrementWhatsNewViews)(id);
        ...
        if (request.method === "PUT") {
            ...
            await (0, whatsnewService_1.updateWhatsNew)(id, updatePayload);
            response.json({ success: true });
            return;
        }
        if (request.method === "DELETE") {
            await (0, whatsnewService_1.deleteWhatsNew)(id);
            response.json({ success: true });
            return;
        }

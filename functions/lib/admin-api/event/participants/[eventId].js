 ...
 */
async function handle(request, response, eventId) {
    try {
        if (request.method === "GET") {
            ...
            const result = await (0, eventParticipantService_1.getEventParticipants)({ eventId, page, limit, search });
        ...
        if (request.method === "POST") {
            ...
            try {
                const id = await (0, eventParticipantService_1.createEventParticipant)({
                    eventId,
...
//# sourceMappingURL=%5BeventId%5D.js.map
...
const whatsnewService_1 = require("../lib/admin/whatsnewService");
const faqService_1 = require("../lib/admin/faqService");
const faqCategoryService_1 = require("../lib/admin/faqCategoryService");
...
app.use(async (req, res, next) => {
        ...
        if (req.method === "GET") {
            ...
            if (eventIdMatch) {
                ...
                try {
                    ...
                    const result = await (0, eventService_1.getEvents)(options);
                    res.json(result);
                }
                catch (error) {
    ...
    if (path.startsWith("/product/whatsnews")) {
        if (req.method === "GET") {
            ...
            if (whatsNewIdMatch) {
                ...
                try {
                    const whatsNew = await (0, whatsnewService_1.getWhatsNewById)(whatsNewId);
                    if (!whatsNew) {
                ...
                try {
                    ...
                    const result = await (0, whatsnewService_1.getWhatsNews)(options);
                    res.json(result);
                }
                catch (error) {
    ...
    if (path.startsWith("/resources/faqs")) {
        if (req.method === "GET") {
            ...
            if (faqIdMatch) {
                ...
                try {
                    const faq = await (0, faqService_1.getFAQById)(faqId);
                    if (!faq) {
                ...
                try {
                    ...
                    const result = await (0, faqService_1.getFAQs)(options);
                    res.json(result);
                }
                catch (error) {
    ...
    if (path === "/resources/faq-categories") {
        if (req.method === "GET") {
            try {
                const categories = await (0, faqCategoryService_1.getFAQCategories)();
                res.json({ categories });
            }
            catch (error) {
    ...
    if (path.startsWith("/resources/glossaries")) {
        if (req.method === "GET") {
            ...
            if (glossaryIdMatch) {
                ...
                try {
                    const glossary = await (0, glossaryService_1.getGlossaryById)(glossaryId);
                    if (!glossary) {
                ...
                try {
                    ...
                    const result = await (0, glossaryService_1.getGlossaries)(options);
                    res.json(result);
                }
                catch (error) {
    ...
    if (path === "/resources/glossary-categories") {
        if (req.method === "GET") {
            try {
                const categories = await (0, glossaryCategoryService_1.getGlossaryCategories)();
                res.json({ categories });
            }
            catch (error) {
    ...
    if (path.startsWith("/resources/blogs")) {
        if (req.method === "GET") {
            ...
            if (blogIdMatch) {
                ...
                try {
                    const blog = await (0, blogService_1.getBlogPostById)(blogId);
                    if (!blog) {
                    ...
                    // 조회수 증가
                    try {
                        await (0, blogService_1.incrementBlogPostViews)(blogId);
                    }
                    catch (viewError) {
                ...
                try {
                    ...
                    const result = await (0, blogService_1.getBlogPosts)(options);
                    res.json(result);
                }
                catch (error) {
